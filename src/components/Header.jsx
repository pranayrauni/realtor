...
export default function Header() {
    ...
    const location = useLocation()      //used for getting pathname from link
  ...
  return (
    <div className='bg-white border-b shadow-sm sticky top-0 z-50'>
        <header className='flex justify-between items-center px-3 max-w-6xl mx-auto'>
            <div>
                <img src="https://static.rdc.moveaws.com/rdc-ui/logos/logo-brand.svg" alt="logo" className='h-5' onClick={() => navigate("/")} />
            </div>
            <div>
